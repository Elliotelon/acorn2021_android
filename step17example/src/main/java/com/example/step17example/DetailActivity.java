...
public class DetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //dto에 담긴 회원정보를 EditText에 출력해 보세요.
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //웹서버에 요청할 url
                String url="http://192.168.219.108:8888/spring04/api/member/update.do";
                //요청 파라미터를 map에 담는다.
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int num=dto.getNum();
                //웹서버에 요청할 url
                String url="http://192.168.219.108:8888/spring04/api/member/delete.do";
                //요청 파라미터를 map에 담는다.
                Map<String, String> params=new HashMap<>();
                params.put("num", Integer.toString(num));
        ...
        new AlertDialog.Builder(this)
                ...
                .setNeutralButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //DetailActivity가 종료 되도록 한다.
                        //결과적으로 onStop()까지 호출되어서 비활성화 된 상태로 대기중이던
                        //MainActivity가 OnReStart() onStart() onResume()이 호출되면서
                        //다시 활성화가 된다.
                        //따라서 OnStart() 메소드 안에서 회원목록을 서버에 다시 요청하게
                        //되기 때문에 업데이트 된 회원 목록을 볼 수 있는 것이다.
                        finish();

...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //최초로 앱이 실행될때 new DBHelper(Context type, 생성될 DB 파일의 이름, 팩토리, 버전)시점에 의 onCreate() 메소드 호출됨.
        ...
        //UI의 참조값을 얻어와서 기본 동작을 준비한다.
        inputText=findViewById(R.id.inputText);
        Button addBtn=findViewById(R.id.addBtn);
        addBtn.setOnClickListener(this);
        //todo 테이블에 있는 content를 SELECT 해서 ListView 에 출력해 보세요.
    ...
    public void onClick(View v) {
        ...
        //6.모델의 내용이 바뀌었다고 아답타에 알려서 ListView를 업데이트 한다.
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        //position은 long 클릭한 인덱스이고, id는 해당 아이템의 primary key이다.

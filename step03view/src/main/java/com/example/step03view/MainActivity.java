...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            레이아웃 리소드 아이디를 전달하면 자동으로 UI 객체들이 생성되고
            생성된 UI가 화면을 구성하게 된다.
            예제 에서는 ConstraintLayout, EditText, Button, TextView 객체가 생성이 되어서
            화면 구성을 하게 된다.
    ...
    public void sendClicked(View v){
        ...
        //2. Toast에 읽어온 문자열을 띄운다.
        // 액티비티의 메소드 안에서 Context type이 필요하면 this를 전달하면 된다.
        Toast.makeText(this, msg, Toast.LENGTH_LONG).show();

        //3. TextView 에도 출력
        TextView textView=findViewById(R.id.textView);
        textView.setText(msg);
        //4. EditText에 입력된 문자열 삭제
        a.setText("");
    }
}
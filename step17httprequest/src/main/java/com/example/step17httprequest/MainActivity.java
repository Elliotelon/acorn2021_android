    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                String url="http://192.168.219.108:8888/AndroidServer/info.jsp";
        ...
        requestBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://192.168.219.108:8888/AndroidServer/info2.jsp";
        ...
        requestBtn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://192.168.219.108:8888/AndroidServer/info3.jsp";
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url="http://192.168.219.108:8888/AndroidServer/send.jsp";
    ...
    public void onSuccess(int requestId, Map<String, Object> result) {
        ...
        switch (requestId){
            case 1:
                 ...
                 */
                try {
                    //data는 {} 형식의 문자열이기 때문에 JSONObject 객체 생성하면서
                    //생성자의 인자로 data를 전달한다.
                    JSONObject obj=new JSONObject(data);
                    // "num" 이라는 키 값으로 저장된 int 얻어내기
                    int num=obj.getInt("num");
                    // "name" 이라는 키 값으로 저장된 String 얻어내기
                    String name=obj.getString("name");
                    // "isMan" 이라는 키 값으로 저장된 boolean 얻어내기
            ...
            case 2:
                try {
                    //data 는 [] 형식잉므로 JSONArray 객체를 생성하면서
                    //생성자의 인자로 data를 전달한다.
                    JSONArray arr=new JSONArray(data);
                    //일단 지우고
                    console.setText("");
                    //JSONArray의 사이즈만큼 반복문 돌면서
            ...
            case 3:
                ...
                break;
            case 4:
                //data는 HTML 형식임으로 그냥 EditText에 출력해 보기

...
public class GalleryListActivity extends AppCompatActivity
    ...
    public static final String IMAGELIST_URL="http://192.168.219.108:8888/spring05/gallery/list_android.do";;
    ...
    public void onSuccess(int requestId, Map<String, Object> result) {
        ...
        try{
            ...
            for(int i=0; i<arr.length(); i++){
                ...
                dto.setNum(num);
                dto.setImageUrl("http://192.168.219.108:8888/spring05"+imagePath);
